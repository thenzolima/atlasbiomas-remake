...
<body>
  <article class="markdown-body"><h1 class="atx" id="politica-de-privacidade-do-aplicativo-album-biomas-do-sul-da-bahia">Política de Privacidade do Aplicativo Álbum Biomas do Sul da Bahia</h1>
<p>Agradecemos inicialmente por escolher utilizar o aplicativo Álbum Biomas do
Sul da Bahia. Esta política de privacidade tem como objetivo explicar como
coletamos, usamos e protegemos as informações dos usuários ao utilizar
nosso aplicativo.</p>
<h3 class="atx" id="coleta-de-informacoes">Coleta de Informações</h3>
<p>O aplicativo Álbum Biomas do Sul da Bahia valoriza a privacidade dos
usuários e, portanto, esclarece que não coleta informações pessoais. Não
solicitamos dados como nome, endereço, número de telefone ou qualquer
outra informação que possa identificar individualmente os usuários.</p>
<h3 class="atx" id="uso-de-informacoes">Uso de Informações</h3>
<p>O aplicativo Álbum Biomas do Sul da Bahia foi desenvolvido para apresentar
informações sobre a fauna e flora dos biomas presentes na região Sul da
Bahia. Essas informações, incluindo textos e imagens, são fornecidas de
forma geral e não são personalizadas para cada usuário. O objetivo é
proporcionar conhecimento e apreciação da biodiversidade local.</p>
<h3 class="atx" id="compartilhamento-de-informacoes">Compartilhamento de Informações</h3>
<p>Reiteramos que o aplicativo não coleta informações pessoais dos usuários.
Portanto, não compartilhamos informações pessoais com terceiros, uma vez
que não as coletamos. As informações disponibilizadas no aplicativo são de
acesso público e não são utilizadas para fins comerciais ou de marketing.</p>
<h3 class="atx" id="seguranca">Segurança</h3>
<p>A segurança das informações é uma prioridade para nós. Implementamos
medidas adequadas para proteger as informações disponibilizadas no
aplicativo Álbum Biomas do Sul da Bahia contra acesso não autorizado,
alteração ou divulgação.</p>
<h3 class="atx" id="atualizacoes">Atualizações</h3>
<p>Podemos atualizar esta política de privacidade ocasionalmente.
Recomendamos que os usuários revisem regularmente esta política para se
manterem informados sobre como protegemos e utilizamos as informações.</p>
<h3 class="atx" id="contato">Contato</h3>
<p>Caso tenha alguma dúvida ou preocupação sobre nossa política de
privacidade ou sobre o uso das informações no aplicativo Álbum Biomas do
Sul da Bahia, por favor, entre em contato conosco através do endereço de
e-mail <strong><a href="mailto:brunarehem@ifba.edu.br">brunarehem@ifba.edu.br</a></strong>.</p>
<p>Ao utilizar o aplicativo Álbum Biomas do Sul da Bahia, você concorda com
esta política de privacidade e com o uso das informações conforme descrito
acima.</p>
</article>
</body>
</html>